...
public class SignatureContentSamples extends KsiSamples {
	...
	public void printPublicationRecord() throws IOException, KSIException {
		...
		if (spr != null)
			System.out.println("printPublicationRecord > publication time >"
					+ spr.getPublicationTime());
		else
			System.out.println(
					"printPublicationRecord > No publication record in signature");
	}
	...
	public void printAhc() throws IOException, KSIException {
		...
		for (AggregationHashChain ahc : signature.getAggregationHashChains()) {
			System.out.println(
					"printAhc > link count > " + ahc.getChainLinks().size());
		}
	}
	...
	public void printChc() throws IOException, KSIException {
		...
		System.out.println(
				"printChc > publication time > " + chc.getPublicationTime());
		System.out.println(
				"printChc > registration time > " + chc.getRegistrationTime());
	...
	public void printSigningTime() throws IOException, KSIException {
		...
		System.out.println(
				"printSigningTime > " + signature.getAggregationTime());
	}
	...
	public void printCalendarAuthenticationRecord()
		...
		CalendarAuthenticationRecord car = signature
		...
		System.out
				.println("printCalendarAuthenticationRecord > signature type > "
						+ signatureData.getSignatureType());
	}
}
